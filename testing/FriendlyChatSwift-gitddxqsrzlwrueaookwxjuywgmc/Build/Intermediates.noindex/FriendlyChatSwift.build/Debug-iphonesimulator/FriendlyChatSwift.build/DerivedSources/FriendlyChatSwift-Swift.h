...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FriendlyChatSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface FCViewController : UIViewController <FIRInviteDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
...
- (IBAction)inviteTapped:(id _Nonnull)sender;
- (void)inviteFinishedWithInvitations:(NSArray * _Nonnull)invitationIds error:(NSError * _Nullable)error;
- (void)loadAd;
